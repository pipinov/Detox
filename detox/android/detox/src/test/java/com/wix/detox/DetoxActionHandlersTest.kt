...
class QueryStatusActionHandlerTest : DetoxActionHandlerTestBase() {
    ...
    @Test fun `should reply with a 'busy' if there's at least one busy resource`() {
        val busyResource = aBusyIdlingResource("mockResource")
        withBusyResources(listOf(busyResource))
    ...
    @Test fun `should reply with a description of a busy resource`() {
        ...
        argumentCaptor<Map<String, Any?>>().apply {
            ...
            assertThat(idleResourceData.get("name")).isEqualTo(busyResource.javaClass.simpleName)
    ...
    @Test fun `should reply with a description of multiple busy resources`() {
        val busyResource1 = aBusyIdlingResource("mockResource1")
        val busyResource2 = aBusyIdlingResource("mockResource2")
        withBusyResources(listOf(busyResource1, busyResource2))
    ...
    private fun aBusyIdlingResource(resourceName: String): IdlingResource =
